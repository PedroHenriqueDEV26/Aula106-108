...
function gotResult(error, results) {
    ...
    img1 = document.getElementById("kakashi");
    img2 = document.getElementById("sasuke");
    img3 = document.getElementById("mC");
    img4 = document.getElementById("allmight");

    if(results[0].label == "Estalo"){
        img1.src = "kakashi-fortnite.gif";
        img2.src = "sasuke.png";
        img3.src = "MasterChief.webp";
        img4.src = "All_Might.webp";
    }
        ...
        img2.src = "sasuke.png";
        img3.src = "MasterChief.webp";
        img4.src = "all-might-fortnite.gif";
    }

    else{
        img1.src = "kakashi-removebg-preview.png";
        img2.src = "sasuke.png";
        img3.src = "masterchief.gif";
        img4.src = "All_Might.webp";
    }
